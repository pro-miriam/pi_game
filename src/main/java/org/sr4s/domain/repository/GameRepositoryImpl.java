...
public class GameRepositoryImpl implements GameRepository{
    ...
    @Override
    public Optional<GameResult> findOne(Predicate predicate) {
        return Optional.empty();
    }

    @Override
    public Iterable<GameResult> findAll(Predicate predicate) {
        return null;
    }

    @Override
    public Iterable<GameResult> findAll(Predicate predicate, Sort sort) {
        return null;
    }

    @Override
    public Iterable<GameResult> findAll(Predicate predicate, OrderSpecifier<?>... orders) {
        return null;
    }

    @Override
    public Iterable<GameResult> findAll(OrderSpecifier<?>... orders) {
        return null;
    }

    @Override
    public Page<GameResult> findAll(Predicate predicate, Pageable pageable) {
        return null;
    }
    ...
    @Override
    public <S extends GameResult, R> R findBy(Predicate predicate, Function<FluentQuery.FetchableFluentQuery<S>, R> queryFunction) {
        return null;
    }
}
